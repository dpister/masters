...
def calculate_spin_correlation(
    spin1_index: int,
    spin2_index: int,
    ...
    for i in range(number_of_states):
        for j in range(number_of_states):
            ...
            s1 = product_state_matrix.spin_values[spin1_index]
            s2 = product_state_matrix.spin_values[spin2_index]
            ...
            if product_state_matrix.state(i) == product_state_matrix.state(j).changed(spin1_index, +1).changed(
                spin2_index, -1
            ):
                result += (
                    1
